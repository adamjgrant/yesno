...
(function() {
  ...
  $YN.isPage = function(controller, action) {
    var $body;
    controller = controller || true;
    action = action || true;
    $body = k$.$('body').dataset;
    return ($body.action === action || action === true) && ($body.controller === controller || controller === true);
  };

  $YN.post = function(endpoint, data, cb, type) {
    var req, token;
  ...
  $YN.put = function(endpoint, data, cb) {
    return $YN.post(endpoint, data, cb, 'PUT');
  };

  $YN.get = function(endpoint, cb) {
    var error, req;
    error = function() {
      return k$.status({
  ...
  $YN.constructPath = function(path, args) {
    var pathParts, regex;
    regex = /(:\w+)/;
  ...
  $YN.mixpanel = function(event, action) {
    var handle, id;
    if (typeof mixpanel !== "undefined") {
      ...
      return mixpanel.track(event, action);
    } else {
      console.debug("A mixpanel event was requested but not sent.");
      return console.debug(event, action);
    }
  };
...
(function() {
  if ($YN.isPage('issues', 'new') || $YN.isPage('issues', 'edit')) {
    $YN.initiateFileUpload = function(s3_direct_post) {
      var $file;
      console.log(s3_direct_post);
      $file = k$.$('[type="file"]');
      return $file.addEventListener('change', function() {
        var $filePath, $input, boundary, req;
        k$.status({
          text: "Uploading...",
          delay: 0
        });
        ...
        req = new XMLHttpRequest();
        req.open('POST', $filePath, true);
        boundary = "AJAX-------------" + (new Date).getTime();
        req.setRequestHeader('Content-Type', "multipart/form-data; boundary=" + boundary);
        return req.sendAsBinary($file.files, boundary);
      });
    };
  }
  ...
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement(CommenterTree, {opinionId: this.opinionId, refresh: this.refresh, comments: this.state.comments, saveComment:  this.saveComment})
      )
    )
  }
});
var CommenterComposer = React.createClass({displayName: "CommenterComposer",
  ...
  render: function() {
    return (
      React.createElement("div", {className: "hide-logged-out"}, 
         this.props.comment ? React.createElement("p", null, "“", this.props.comment.body, "”") : '', 
...
var CommenterTree = React.createClass({displayName: "CommenterTree",
  ...
  render: function() {
    var commentUL = function(comment) {
      var innerComments = React.createElement("strong", null, "None");
      if (comment.comments) {
        innerComments = comment.comments.map(commentUL.bind(this));
      }
      return (
        React.createElement(CommenterTreeComment, {
          comment:  comment, 
    ...
    return (
      React.createElement("div", {"data-block": "comments"}, 
        React.createElement("h1", null, "Comments"), 
        React.createElement(CommenterComposer, {
          issueId: this.props.issueId, opinionId: this.props.opinionId, 
          saveComment:  this.saveComment}
        ), 
        React.createElement("ul", {"data-block": "comments"}, 
           comments, 
           comments.length ? '' : React.createElement("p", null, "No comments yet")
        )
      )
    )
  }
});
var CommenterTreeComment = React.createClass({displayName: "CommenterTreeComment",
  getInitialState: function() {
    return({
  ...
  render: function() {
    return (
      React.createElement("li", {"data-component": "comment"}, 
        React.createElement("div", {"data-component": "modal", className: "modal-" + this.props.comment.id, style:  this.state.modalVisibility, onClick:  this.showModal}, 
          React.createElement(CommenterComposer, {
        ...
        React.createElement("div", {className: "vote-row"}, 
          React.createElement(Voter, {
          ...
          React.createElement("section", null, 
            React.createElement("header", null, 
              React.createElement("img", {src:  this.props.comment.avatar}), 
              React.createElement("span", null, "@" + this.props.comment.handle)
            ), 
            React.createElement("main", null, 
              React.createElement("p", {id:  "comment-" + this.props.comment.id},  this.props.comment.body)
            ), 
...
var Icon = React.createClass({displayName: "Icon",
  render: function() {
    ...
    return (
      React.createElement("svg", {"data-component": "icon", dangerouslySetInnerHTML: {__html: useTag}})
    );
  }
});
var IssueCard = React.createClass({displayName: "IssueCard",
  mixins: [React.addons.LinkedStateMixin],
  componentDidMount: function() {
  ...
  render: function() {
    ...
    if (issue.user_can_vote) {
      voteAction = [
        ...
        React.createElement("span", {key:  "b" + issue.id, className: "hide-logged-out"}, " "),
        React.createElement("div", {
          key:  "c" + issue.id, 
          className: "cta hide-logged-out", 
          href: "", 
      ...
      voteAction = (
        React.createElement("p", {key:  "d" + issue.id, className: "hide-logged-out"},  "Thanks for voting!" )
      )
    }

    return (
      React.createElement("div", {className: "issue_column"}, 
        React.createElement("section", {"data-component": "issue"}, 
          React.createElement("header", {style:  style }, 
            React.createElement(Verdict, {
                score:  score, 
                votes:  votes, 
                response:  response, 
                className: "top", 
          ...
          React.createElement("main", null, 
            React.createElement("h1", null, 
              React.createElement("a", {href: "/issues/" + issue.slug}, issue.name)
            ), 
            React.createElement("p", null, statement)
          ), 
          React.createElement("footer", null, 
            React.createElement("a", {href: authLink, className: "sign-in hide-logged-in"},  "Sign in to vote" ), 
             voteAction 
          )
        ), 
        React.createElement(RedSheet, {
...
;
var IssueIndex = React.createClass({displayName: "IssueIndex",
  getInitialState: function() {
    return {
      issues: [
        {
  ...
  render: function() {
    ...
    var issueCards = this.state.issues.map(function(row) {
      return (
        React.createElement(IssueCard, {issue: row, key: row.id, getData: this.getData})
      )
    }, this)
    return (
      React.createElement("div", {"data-block": "issues"}, 
         issueCards 
      )
    )
  }
...
;
var IssueSingle = React.createClass({displayName: "IssueSingle",
  getInitialState: function() {
    return {
      issue: {
        id: 0,
  ...
  render: function() {
    return (
      React.createElement("div", {className: "row"}, 
        React.createElement("div", {"data-component": "breadcrumbs"}, 
          React.createElement("a", {href: "/"}, "« All issues")
        ), 

        React.createElement(IssueCard, {issue: this.state.issue, getData: this.getData}), 
        React.createElement(OpinionTable, {issue: this.state.issue, getData: this.getData})
      )
    )
  }
})
;
var NotificationBadge = React.createClass({displayName: "NotificationBadge",
  getInitialState: function() {
    return {
      newNotifications: 0
    }
  ...
  render: function() {
    if (this.state.newNotifications > 0) {
      return ( React.createElement("a", {className: "unread", href: "/notifications"},  this.state.newNotifications + " new") );
    }
    else {
      return ( React.createElement("a", {href: "/notifications"}, "Notifications") );
    }
  }
});
var OpinionIndex = React.createClass({displayName: "OpinionIndex",
  mixins: [React.addons.LinkedStateMixin],
  refresh: function() {
    this.props.getData();
  },
  render: function() {
    ...
    var opinionRows = this.props.issue.opinions.map(function(row) {
      if (row.statement !== "null") {
        return (
          React.createElement("div", {key: row.id, "data-component": "opinion"}, 
            React.createElement("article", null, 
              React.createElement(Voter, {
              ...
              React.createElement("p", null, 
                React.createElement("a", {href:  this.props.issue.slug + "/opinions/" + row.slug}, 
                  React.createElement("span", {className: "verdict " + (row.agree ? "yes" : "no") },  row.agree ? "YES" : "NO"), 
                  row.statement
                )
              )
            ), 
            React.createElement("footer", null, 
              React.createElement("img", {src:  row.avatar}), 
              React.createElement("span", null, "@" + row.handle)
            ), 
            React.createElement("footer", null, 
              React.createElement("ul", null, 
    ...
    return (
      React.createElement("div", {"data-component": "opinion_column"}, 
         opinionRows, 
         opinionRows.length ? '' : React.createElement("p", null, "No opinions yet")
      )
    )
  }
})
...
var OpinionSingle = React.createClass({displayName: "OpinionSingle",
  getInitialState: function() {
    return {
      issue: {
        id: 0,
    ...
    return (
      React.createElement("div", {className: "row"}, 
        React.createElement("div", {"data-component": "breadcrumbs"}, 
          ...
          React.createElement("a", {href:  "/issues/" + this.state.issue.id},  this.state.issue.name)
        ), 
        React.createElement(IssueCard, {issue: this.state.issue, getData: this.getData}), 
        React.createElement("div", {className: "opinion_column"}, 
          React.createElement("figure", {"data-component": "opinion_single"}, 
            React.createElement("blockquote", null, "“",  this.state.opinion.statement, "”"), 
            React.createElement("div", {"data-component": "opinion"}, 
              React.createElement("footer", null, 
                React.createElement("img", {src:  this.state.opinion.avatar}), 
                React.createElement("span", null, "@" + this.state.opinion.handle), 
                React.createElement("span", {className: "verdict " + (this.state.opinion.agree ? "yes" : "no")},  this.state.opinion.agree ? "YES" : "NO")
              )
            )
          ), 
          React.createElement(Commenter, null)
        )
      )
    )
  }
});
var OpinionTable = React.createClass({displayName: "OpinionTable",
  render: function() {
    var style = this.props.issue.image ? { backgroundImage: 'url(' + this.props.issue.image + ')' } : {};
    return (
      React.createElement("section", {"data-component": "opinion_table"}, 
        React.createElement("h1", null, "Opinions"), 
        React.createElement("div", null, 
          React.createElement(OpinionIndex, {
            issue: this.props.issue, 
            getData: this.props.getData}
          )
        )
...
;
var RedSheet = React.createClass({displayName: "RedSheet",
  getInitialState: function() {
    return {
      talked: false,
      response: {
  ...
  render: function() {
    return (
      React.createElement("div", {"data-component": "red_sheet", className: this.props.displayLink.value ? "show" : ""}, 
        React.createElement("div", {className: "wrapper"}, 
          React.createElement("button", {className: "close", onClick: this.close}, "×"), 
          React.createElement("h1", null, this.props.issue.name), 
          React.createElement("label", null, 
            React.createElement("input", {type: "radio", name: "opinion", value: "true", checked: this.props.agree, onChange: this.updateAgree}), 
            "Yes"
          ), 
          React.createElement("label", null, 
            React.createElement("input", {type: "radio", name: "opinion", value: "false", checked: !this.props.agree, onChange: this.updateAgree}), 
            "No"
          ), 
          React.createElement("p", null, "Tell us why below"), 
          React.createElement("textarea", {
...
;
var Verdict = React.createClass({displayName: "Verdict",
  render: function() {
    ...
    return (
      React.createElement("aside", {className:  (score == 0 ? '' : response.toLowerCase()) + " verdict " + this.props.className}, 
...
;
var Voter = React.createClass({displayName: "Voter",
  ...
  render: function() {
    ...
    if (this.props.editable) {
      upButton.push(
        React.createElement("div", {key: "ubd1-" + this.props.keyId}, 
          React.createElement("button", {className: "hide-logged-in up", key: "ub1-" + this.props.keyId, onClick: this.signInWithTwitter}), 
          React.createElement("button", {className: "hide-logged-out up", key: "ub2-" + this.props.keyId, onClick: this.upvote})
        )
      )
      downButton.push(
        React.createElement("div", {key: "dbd1-" + this.props.keyId}, 
          React.createElement("button", {className: "hide-logged-in down", key: "db1-" + this.props.keyId, onClick: this.signInWithTwitter}), 
          React.createElement("button", {className: "hide-logged-out down", key: "db2-" + this.props.keyId, onClick: this.downvote})
        )
      )
    }

    return (
      React.createElement("figure", {"data-component": "voter", key:  "voter-" + this.props.keyId}, 
         this.props.disableUp ? null: upButton, 
        React.createElement("h1", null, this.props.score), 
...
if ($YN.isPage('issues', 'index')) {
  React.render(
    React.createElement(IssueIndex, {url: "issues.json"}),
    k$.$('[data-render]')
  )
}
...
if ($YN.isPage('issues', 'show')) {
  React.render(
    React.createElement(IssueSingle, null),
    k$.$('[data-render]')
  )
}
;
...
if ($YN.isPage('opinions', 'show')) {
  React.render(
    React.createElement(OpinionSingle, null),
    k$.$('[data-render]')
  )
}
;
